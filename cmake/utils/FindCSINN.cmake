...
macro(find_csinn use_csinn target)
  ...
  if(__csinn_library)
    ...
    if(__target STREQUAL "X86")
      find_library(CSINN_LIBRARIES NAMES libcsi_nn2_ref_x86.so PATHS ${__csinn_library}/lib)
    elseif(__target STREQUAL "C906")
      find_library(CSINN_LIBRARIES NAMES libcsi_nn2_c906.so PATHS ${__csinn_library}/lib)
    else()
      find_library(CSINN_LIBRARIES NAMES libcsi_nn2_ref_x86.so PATHS ${__csinn_library}/lib)
    endif()
    if(CSINN_LIBRARIES)
