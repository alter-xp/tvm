...
def _get_softmax_model(shape, dtype, axis, var_names):
    """Return a model and any parameters it may have."""
    out = relay.var(next(var_names), shape=shape, dtype=dtype)

    out = relay.nn.softmax(
        out,
        axis=axis,
    )
...
def test_softmax():
    ...
    # fmt: off
    trials = [
        [fp32_dtype, (512, 27, 27), 1],
        [fp32_dtype, (16, 16, 16), 1],
        [fp32_dtype, (16, 15, 15), 1],
        [fp32_dtype, (16, 16, 16), 1],
    ]
    # fmt: on
    for (
